...
// Provide a fallback local IP just in case .env is missing while testing locally.
const SERVER_URL = process.env.EXPO_PUBLIC_SERVER_URL || 'https://checkme-production.up.railway.app/upload/';
